...
true: 1. if it is an empty string 2. if A and B are correct, AB is 
...
The part of the code that handles input operation is already provided
in the editor.
