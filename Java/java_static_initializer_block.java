...
is loaded, and you can initialize static variables in
those blocks.
...
with breadth  and height H. You should read the variables from 
the standard input.
...
There are two lines of input. The first line contains B: the 
breadth of the parallelogram. The next line contains H: the 
